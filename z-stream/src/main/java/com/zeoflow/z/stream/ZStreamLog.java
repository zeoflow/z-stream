 ...
 *
 * <p>to see ZStream logs call:<br>
 * {@code <android-sdk>/platform-tools/adb shell setprop log.tag.ZStream VERBOSE}
 */
public class ZStreamLog
{
    /**
     ...
     */
    private static final String CLASS_NAME = ZStreamLog.class.getName();
    public static String TAG = "ZStream";
    public static boolean DEBUG = Log.isLoggable(TAG, Log.VERBOSE);

    /**
     * Customize the log tag for your application, so that other apps using ZStream don't mix their
     * logs with yours. <br>
    ...
    private static String buildMessage(String format, Object... args)
    {
        ...
        for (int i = 2; i < trace.length; i++)
        {
            ...
            if (!clazz.equals(ZStreamLog.CLASS_NAME))
            {
