...
import com.zeoflow.z.stream.ResponseDelivery;
...
public class ImageLoader
{
    ...
    /**
     * The cache implementation to be used as an L1 cache before calling into zstream.
     */
     ...
     * @param cacheKey The cache key that is associated with the image request.
     */
    protected void onGetImageError(String cacheKey, ZStreamError error)
    {
     ...
     * cache before dispatch to ZStream. Implementations must not block. Implementation with an
    ...
    private static class BatchedImageRequest
    {
         ...
         */
        public void setError(ZStreamError error)
        {
            mError = error;
        }
